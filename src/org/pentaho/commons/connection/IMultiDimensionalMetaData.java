...
public interface IMultiDimensionalMetaData {
   ...
   * This method has been moved here from IPentahoMetaData
   */
  public Object[][] getRowHeaders();
  
  /**
   * Gets the column names. These names include the names of the row dimensions
   * and flattened column headers
   * @return
   */
  ...
  /**
   * Sets the column name format string. The values in the column headers will
   * be inserted into the format template based on their index (0 based).
   * 
   * e.g if the column headers are:
   * 2009  2009  2008
   * Apr   Jan   Oct
   * 
   * and the format string is {1}-{0} the column names will end up as:
   * Apr-2009,Jan-2009,Oct-2008
   * 
   * @param formatStr
   */
