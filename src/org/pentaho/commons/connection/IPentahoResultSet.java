...
/**
 * Defines a set of result data, typically with definable rows and
 * columns. Supports multi-dimensional data sets.
 * 
 * @author wseyler
 * @see IDisposable
 * 
...
public interface IPentahoResultSet extends IDisposable {
   ...
   * @return array represeting a column of data. 0th element is the first
   *         column
   */
