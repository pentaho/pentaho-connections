 ...
 * These types are used to provide metadata about the rows of data stored in
 * a MarshallableResultSet object
 * @author jamesdixon
 *
 */
public class MarshallableColumnTypes implements Serializable {
  ...
  public static String getDataType( String javaType ) {
	 ...
	 * See org.pentaho.commons.connection.IPentahoDataTypes for the types
	 * supported.
	 * 
	 * @param types
	 */
