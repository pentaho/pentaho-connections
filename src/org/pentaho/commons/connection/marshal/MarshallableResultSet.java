...
/**
 * A serializable representation of an IPentahoResultSet. This class can be 
 * populated from an IPentahoResultSet object and serialized. A MemoryResultSet 
 * object can be created from one of these using WSResultSetUtil
 * 
 * @author jamesdixon
 *
 */
