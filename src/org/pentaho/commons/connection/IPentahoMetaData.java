...
public interface IPentahoMetaData {
   ...
   * 
   * NOTE: 2D data will contain a column header that is 1 x N where N is the
   ...
   * the column header cannot be found -1 is returned. If there is more than 1
   * column header dimentsions -1 is returned.
   * 
   * @param value
  ...
  /**
   * Gets the 0-based row number for a specified row header value. If the row
   * header cannot be found -1 is returned. If there is more than 1 row header
