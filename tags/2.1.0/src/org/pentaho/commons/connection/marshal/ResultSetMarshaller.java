...
/**
 * A utility class for marshalling IPentahoResultSet objects into and out of
 * a serializable form (MarshallableResultSet)
 * 
 * @author jamesdixon
 *
 */
public class ResultSetMarshaller  {
   ...
   * A MemoryResultSet object is used as the implementation.
   * @param data
   * @return
   */
